...
export { default as Ptol } from "./ptol.interface";
export { default as PostScript } from "./postscript.interface";
export { default as LokomotiveNumber } from "./lokomotivenumber.interface";
