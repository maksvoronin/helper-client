...
import { Changelog, Comment, Decision, DetailComment, DetailDecision, Index, Liked, My, Profile, Rating, Search, Settings, Subscribed, System, Welcome } from "../@pages";
...
const mainRoutes = [
  ...
  {
    path: `/${baseURI}/decision/:id`,
    element: <DetailDecision title="Решение" />,
  },
  {
    path: `/${baseURI}/system/:id`,
  ...
  },
  {
    ...
    element: <Navigate to={`/${baseURI}/favorite`} />,
  },
  {
